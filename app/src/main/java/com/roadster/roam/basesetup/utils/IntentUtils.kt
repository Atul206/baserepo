...
fun openContactUs(context: Context, emailId:String, subject:String) {
    val intent = Intent(Intent.ACTION_VIEW).apply {
        data = Uri.parse(
            "mailto:${emailId}?subject=${subject}"
        )
    }
...
fun Fragment.goToSecuritySettings() = startActivity(Intent(Settings.ACTION_SECURITY_SETTINGS))
